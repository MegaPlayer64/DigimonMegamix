...
### ¿Cómo se cuanto daño hare?
        ...
        Ellos se comportan justo como un "piedra, papel o tijeras" en donde el ganador obtiene un bono de x1.5 al ataque y el perdedor obtiene x0.5 de poder el ataque.
        La tabla de quien gana a quien es:
        -> Vacuna -> Virus -> Datos ->
        En el caso de ser el opuesto un ataque "Libre", actuara al igual que uno "Libre" (Con su respectivo bono de atributo si posee la creatura selecionada)

        - Libre: El ataque libre es un ataque el cual no puede ser afectado por la eleccion del rival (Siempre hara el mismo daño)
...
### ¿Cómo funciona las evoluciones?
        ...
        Además, aumentaran la vida de los monstruos
